...
export const submitPlacement = async (req, res, next) => {
  try {
    ...
    const skillStats = { grammar: { correct: 0, total: 0 }, vocabulary: { correct: 0, total: 0 }, reading: { correct: 0, total: 0 } };
    let totalCorrect = 0;
    ...
    answers.forEach(({ questionId, answer }) => {
      ...
      const skill = SKILLS.includes(question.skill) ? question.skill : 'grammar';
